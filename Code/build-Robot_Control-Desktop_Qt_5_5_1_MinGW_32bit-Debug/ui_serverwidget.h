...
public:
    ...
    {
        ServerWidget->setWindowTitle(QApplication::translate("ServerWidget", "Form", 0));
        pushButtonSend->setText(QApplication::translate("ServerWidget", "send", 0));
        pushButtonClose->setText(QApplication::translate("ServerWidget", "close", 0));
    } // retranslateUi
